...
public class TimeUtil {
    ...
    public static final String SHORT_TIMESTAMP_FORMAT_TIME = "HH:mm:ss";
    ...
    public static String getShortTime(Date date) {
        return getSimpleDate(date, SHORT_TIMESTAMP_FORMAT_TIME);
    }
     ...
     * @param t1
     * @param t2
     * @return long minutes = t1-t2
     */
    public static long equal(Calendar t1, Calendar t2){
        Long diff = t1.getTime().getTime()-t2.getTime().getTime();
        if(diff < 0){
            return 0;
        }
        return diff/1000/60;
     ...
     * @return int
     */
    public static int equal(Date t1, Date t2){
    ...
    public static void main(String[] args) {
        Date endTime = new Date("05/24/2021 23:00:00");
        Date startTime = new Date("05/24/2021 19:00:00");
        System.out.println(equal(endTime, startTime));
    }
